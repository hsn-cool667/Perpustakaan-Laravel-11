            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('sres') }}" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="alamat" class="form-control" id="yourAlamat" required>
                      <div class="invalid-feedback">Please enter a valid Email adddress!</div>
                    </div>
                    ...
                    <div class="col-12">
                      <div class="input-group has-validation">
                        ...
                        <input type="hidden" name="level" class="form-control" value="peminjam">
                      </div>
                    </div>
                    <div class="col-12">
